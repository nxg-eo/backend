...
<style>
    @media (max-width: 768px) {
        .ai-business-section .info-section.mobile-spacing {
            margin-bottom: 2rem; /* Add more space below location */
        }
        .ai-business-section .mobile-separator {
            display: block; /* Ensure separator is visible */
            margin: 2rem 0; /* Add spacing around the separator */
        }
        .ai-business-section .mobile-separator .blue-divider {
            background-color: #007bff; /* Blue color for the separator */
            ...
            <div class="col-lg-6">
                <div class="section-content">
                    ...
                    <div class="section-buttons">
                        <button class="btn btn-primary text-uppercase d-none" data-bs-toggle="modal"
...
<section class="ai-business-section">
    <div class="container">
        <div class="row align-items-center mb-5 pb-5 d-none">
            <div class="col-lg-3">
            ...
            <div class="col-lg-9">
                <div class="highlights-list">
                    Future Trends & Exponential Thinking | Build Your AI Canvas v1 | Prompt-Engineering Bootcamp |
                    Agentic AI & Workflow Automation | Data Readiness Clinic | Rapid-Prototype Lab
                </div>
            </div>
        </div>
        <section class="textSlide mb-5 pb-5">
            <!-- <div Class="Textheading">Highlights |</div> -->
            <div class="btn-highlight">
                    Highlights
                </div>
            <div class='marquee-with-options' style="width:100%;">
                <a href="#">
                Future Trends & Exponential Thinking
                    <span class="dot-1"><img src="assets/img/Ellipse%2012.png"></span>
                    Build Your AI Canvas v1
                    <span class="dot-1"><img src="assets/img/Ellipse%2012.png"></span>
                    Prompt-Engineering Bootcamp
                    <span class="dot-1"><img src="assets/img/Ellipse%2012.png"></span>
                    Agentic AI & Workflow Automation
                    <span class="dot-1"><img src="assets/img/Ellipse%2012.png"></span>
                    Data Readiness Clinic
                    <span class="dot-1"><img src="assets/img/Ellipse%2012.png"></span>
                    Rapid-Prototype Lab
                    <span class="dot-1"><img src="assets/img/Ellipse%2012.png"></span>
                </a>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="section-content">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="info-section">
                                <h5 class="info-title">
                                    HOSTED<br>
                                    <b>BY</b> <img src="assets/img/logo-powered.png" alt="" class="img-fluid"
                                        width="50">
                                </h5>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="info-section mobile-spacing"> <!-- Added mobile-spacing class -->
                                <h5>
                                    <b>
                                        23-24 JANUARY
                                    </b>
                    ...
                    <div class="d-block d-lg-none mobile-separator">
                        <div class="divider-line blue-divider"></div> <!-- Added blue-divider class -->
                    </div>
                        ...
                        <div class="speaker-card-back">
                            <div class="speaker-back-content">
                                ...
                                <div class="speaker-back-description">
                                    Biomedical engineer, AI strategist, and innovation expert. Co-founder of AURA,
                                    dsrupt.ai, and PRTL Medical. Creator of “Brainternet,” the world’s first
                                    brain-to-internet connection. Global Fellow of the IET (UK). Specialist in AI
                                    implementation, healthcare innovation, and digital transformation.
                                </div>
                    ...
                    <div class="speaker-card-inner">
                        ...
                        <div class="speaker-card-back">
                            <div class="speaker-back-content">
                                ...
                                <div class="speaker-back-description">
                                    Professor of Computer Science at the University of the Witwatersrand and Director of
                                    the MIND Institute. Founder of Lelapa AI and Deep Learning Indaba. Named among TIME
                                    100 Most Influential in AI (2025). Expert in reinforcement learning and autonomous
                                    systems.
                                </div>
                    ...
                    <div class="speaker-card-inner">
                        ...
                        <div class="speaker-card-back">
                            <div class="speaker-back-content">
                                ...
                                <div class="speaker-back-description">
                                    Founder & CEO of Rehumanize Institute and former CEO of SingularityU Nordic. Amazon
                                    #1 bestselling author and UN Fellow. Twice nominated Female Entrepreneur of the Year
                                    (Denmark). Global speaker on impact leadership, exponential technologies, and the
                                    future of work.
                                </div>
                            ...
                            <div class="accordion mt-3" id="faqAccordionInner1">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse1_1" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            This is a 2-day immersive workshop designed to move EO members from AI
                                            strategy to hands-on implementation. Over two days, participants will
                                            explore frameworks, tools, and real-world use cases, then build AI
                                            prototypes and 90-day pilot plans they can take back to their companies. The
                                            program is inspired by Singularity University-style experiential learning
                                            and tailored for EO entrepreneurs.
                                        </div>
                                    </div>
                                </div>
                                <!-- Nested item 1.2 -->
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse1_2" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            The program is open to EO Dubai members, SLPs, NextGen members, EOA, Key
                                            Executives, and EO members from other chapters. Each session is designed for
                                            business leaders and teams who want to integrate AI practically into their
                                            business models.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse1_4" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            The participation fee is AED 5,999 per person for other EO attendees.
                                        </div>
                                    </div>
                                </div>
                                <!-- Nested item 1.5 -->
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading1_5">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            5. How does the group discount work for teams of five or more EO members
                                            from outside Dubai?
                                        </button>
                                    </h2>
                                    <div id="collapse1_5" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Groups of five or more EO members attending together from other chapters
                                            will receive a group discount and will pay only $1000 per attendee. The
                                            exact discounted rate will be shared at registration.
                                        </div>
                                    </div>
                                </div>
                                <!-- Nested item 1.6 -->
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading1_6">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            6. Where can I view the detailed event policy?
                                        </button>
                                    </h2>
                                    <div id="collapse1_6" class="accordion-collapse collapse"
                                        aria-labelledby="heading1_6" data-bs-parent="#faqAccordionInner1">
                                        <div class="accordion-body">
                                            Please see the detailed event policy here: <a href="https://eodubai.com/ai-for-business/event-policy.php" target="_blank">https://eodubai.com/ai-for-business/event-policy.php</a>.
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion mt-3" id="faqAccordionInner2">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse2_1" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Registration can be completed through the EO Dubai events portal or link
                                            shared via email. Spaces are limited to 120 participants, so early
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse2_2" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Yes. Groups of five or more EO members from outside Dubai receive a special
                                            discounted rate.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="accordion mt-3" id="faqAccordionInner3">
                                    ...
                                    <div id="collapse3_1" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <ul style="margin:0; padding-left:1rem;">
                                                <li><strong>Day 1: AI Foundations & Opportunity Mapping</strong> –
                                                    Frameworks, readiness assessment, sector case studies, and building
                                                    your first AI Canvas.</li>
                                                <li><strong>Day 2: Tools, Prototyping & Pilot Commitments</strong> –
                                                    Prompt engineering, workflow automation, data readiness clinics,
                                                    rapid prototyping, and 90-day pilot presentations.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="heading3_2">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            11. Will there be hands-on workshops and opportunities for prototype
                                            building?
                                        </button>
                                    </h2>
                                    <div id="collapse3_2" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Absolutely. Both days are designed around "show-then-do" learning.
                                            Participants will build live prototypes, AI workflows, and pilot plans
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse3_4" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Yes. The event includes networking lunches, coffee breaks, and refreshments
                                            both days.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="accordion mt-3" id="faqAccordionInner4">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse4_1" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Yes. Participants will receive a pre-event learning pack three weeks before
                                            the program.
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="collapse4_2" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <ul style="margin:0; padding-left:1rem;">
                                                ...
                                                <li>A Reading Pack (McKinsey State of AI Digest + WEF SME Toolkit
                                                    Extract)</li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse4_3" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Yes. EO Dubai will host a 30-Day Virtual Progress Clinic and Quarterly Demo
                                            Days to help participants implement and showcase their AI pilots.
                                        </div>
                                    </div>
                                </div>
                                <!-- Nested item 4.4 -->
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse4_4" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Participants will collaborate in small peer groups throughout both days,
                                            with shared canvases, prototype sessions, and peer feedback pitches. A new
                                            EO AI Circles network will also be launched for continued accountability and
                                            collaboration.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="accordion mt-3" id="faqAccordionInner5">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapse5_2" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            Valet parking will be available for all participants. Accommodation is not
                                            included but can be booked directly with Marriott at a preferred EO rate
                                            (details to follow).
                                        </div>
                                    </div>
                                </div>
